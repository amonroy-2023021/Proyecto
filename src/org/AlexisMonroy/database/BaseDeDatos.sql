...
call sp_AgregarClientes(1, '123456-7', 'Celeste', 'García', 'zona18, Ciudad A', '123456789', 'Celeste.garcia@example.com');
call sp_AgregarClientes(2, '987654-3', 'Anderson', 'López', 'Avenida Aguilar, Ciudad B', '987654321', 'Anderson.lopez@example.com');
--  -------------------------Listar Clientes-----------------------------------------------
delimiter $$
...
create procedure sp_EditarProveedores (in codProveedor int ,in NProveedor varchar(12),in noProveedor varchar(50),in apProveedor varchar(50),
	in direcProveedor varchar(150) ,in rSocial varchar(60),in conPrincipal varchar(100),in pagWebProveedor varchar(50) ) 
        ...
        razonSocial=rSocial,
        contactoPrincipal=conPrincipal,
